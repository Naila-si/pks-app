...
export default function EditPKSModal({ pksId, onClose, onSubmit }) {
  ...
  // Ambil data PKS dari service saat mount
  useEffect(() => {
    if (pksId) {
      const data = dataService.getPKSById(pksId);
      if (data) {
  ...
  const handleFormSubmit = (e) => {
    ...
    const updatedPKS = {
      ...
      dokumen_url: documentFile ? documentFile.name : (pks.dokumen_url || 'dokumen_pks_baru.pdf')
    };
